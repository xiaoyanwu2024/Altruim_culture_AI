...
# Author : Xiaoyan Wu
# Date   : June 2026
# Description: DG data collection — Mistral-Small-4
# =============================================================================

"""
Mistral Small 4 Task 1 — Dictator Game (Allocator role).
8 countries × 2 genders = 16 responses.
Uses OpenAI-compatible Mistral API.
"""
...
def main():
    ...
    out_path = DATA_DIR / f"mistral_small4_task1_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
